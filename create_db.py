...
con.execute("CREATE TABLE beer (id INTEGER PRIMARY KEY, brewer char(100) NOT NULL, beer char(100) NOT NULL, style char(100) NOT NULL, abv real NOT NULL, size real NOT NULL, amount INT NOT NULL)")
